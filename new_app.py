...
for key in ["joined_events", "joined_circles", "connections", "intro_requests"]:
...
if "notifications" not in st.session_state:
    st.session_state.notifications = [
        ...
        "Wellness Breakfast is sponsor-ready and suitable for brand activation."
    ]
...
.small-muted { color:#73777d; font-size: 14px; }
.match-score {
    display:inline-block;
    background:#c7ff5a;
    color:#111315;
...
with st.sidebar:
    ...
    pages = ["Home", "Onboarding", "AI Matches", "Circles", "Events", "People", "Map", "Profile", "Business", "Admin"]
...
if page == "Home":
    ...
    with right:
        ...
        <div class="card">
          <h3>Real product</h3>
          <p>This app solves loneliness, weak networking and fragmented community access in UAE.</p>
          <p>Sport is only the entry point. The product is social integration.</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    <div class="dark-card">
      ...
      <p>Invite-only communities, AI introductions, VIP events and business networking.</p>
    </div>
    """, unsafe_allow_html=True)
